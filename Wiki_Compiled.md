...
- [04_Knowledge Base/wiki/MOCs/Data-Asset MOC.md](#-file-04_knowledge-base-wiki-mocs-data-asset-moc-md) (~108 words)
...
- [04_Knowledge Base/wiki/MOCs/Hyperspectral Remote Sensing MOC.md](#-file-04_knowledge-base-wiki-mocs-hyperspectral-remote-sensing-moc-md) (~573 words)
- [04_Knowledge Base/wiki/MOCs/Machine-Learning MOC.md](#-file-04_knowledge-base-wiki-mocs-machine-learning-moc-md) (~44 words)
- [04_Knowledge Base/wiki/MOCs/Mineralogy MOC.md](#-file-04_knowledge-base-wiki-mocs-mineralogy-moc-md) (~158 words)
...
- [04_Knowledge Base/wiki/MOCs/Reclamation MOC.md](#-file-04_knowledge-base-wiki-mocs-reclamation-moc-md) (~144 words)
...
- [04_Knowledge Base/wiki/entities/ECOSTRESS Spectral Library.md](#-file-04_knowledge-base-wiki-entities-ecostress-spectral-library-md) (~390 words)
- [04_Knowledge Base/wiki/entities/EnMAP Satellite.md](#-file-04_knowledge-base-wiki-entities-enmap-satellite-md) (~532 words)
- [04_Knowledge Base/wiki/entities/Gantour Basin.md](#-file-04_knowledge-base-wiki-entities-gantour-basin-md) (~448 words)
- [04_Knowledge Base/wiki/entities/Handheld XRF.md](#-file-04_knowledge-base-wiki-entities-handheld-xrf-md) (~508 words)
- [04_Knowledge Base/wiki/entities/Jbel N'Zourk Copper Deposit.md](#-file-04_knowledge-base-wiki-entities-jbel-n'zourk-copper-deposit-md) (~236 words)
...
- [04_Knowledge Base/wiki/entities/PRISMA Satellite.md](#-file-04_knowledge-base-wiki-entities-prisma-satellite-md) (~382 words)
- [04_Knowledge Base/wiki/entities/South Benguerir Phosphate Deposit.md](#-file-04_knowledge-base-wiki-entities-south-benguerir-phosphate-deposit-md) (~391 words)
- [04_Knowledge Base/wiki/entities/Tiouit Gold Deposit.md](#-file-04_knowledge-base-wiki-entities-tiouit-gold-deposit-md) (~302 words)
- [04_Knowledge Base/wiki/entities/Touroug Baryte Deposit.md](#-file-04_knowledge-base-wiki-entities-touroug-baryte-deposit-md) (~211 words)
- [04_Knowledge Base/wiki/entities/X'Pert HighScore Plus.md](#-file-04_knowledge-base-wiki-entities-x'pert-highscore-plus-md) (~368 words)
...
- [04_Knowledge Base/wiki/concepts/Data Asset — AgBS Learning by Doing Cereal and Wheat Dataset.md](#-file-04_knowledge-base-wiki-concepts-data-asset-—-agbs-learning-by-doing-cereal-and-wheat-dataset-md) (~231 words)
...
- [04_Knowledge Base/wiki/concepts/Data Asset — XRD Mineralogy Analysis of Sample Z2-40.md](#-file-04_knowledge-base-wiki-concepts-data-asset-—-xrd-mineralogy-analysis-of-sample-z2-40-md) (~197 words)
...
- [04_Knowledge Base/wiki/concepts/Early Draft — Hyperspectral Characterization of Phosphatic Waste Rocks 2022.md](#-file-04_knowledge-base-wiki-concepts-early-draft-—-hyperspectral-characterization-of-phosphatic-waste-rocks-2022-md) (~265 words)
...
- [04_Knowledge Base/wiki/concepts/Fluorapatite Reference Diffraction Pattern 96-901-0506.md](#-file-04_knowledge-base-wiki-concepts-fluorapatite-reference-diffraction-pattern-96-901-0506-md) (~250 words)
...
- [04_Knowledge Base/wiki/sources/Literature Note — Brossard et al. 2016.md](#-file-04_knowledge-base-wiki-sources-literature-note-—-brossard-et-al--2016-md) (~192 words)
- [04_Knowledge Base/wiki/sources/Literature Note — Casa et al. 2020.md](#-file-04_knowledge-base-wiki-sources-literature-note-—-casa-et-al--2020-md) (~184 words)
- [04_Knowledge Base/wiki/sources/Literature Note — Johansen et al. 2018.md](#-file-04_knowledge-base-wiki-sources-literature-note-—-johansen-et-al--2018-md) (~198 words)
- [04_Knowledge Base/wiki/sources/Literature Note — Rasti et al. 2020.md](#-file-04_knowledge-base-wiki-sources-literature-note-—-rasti-et-al--2020-md) (~180 words)
- [04_Knowledge Base/wiki/sources/Literature Note — Stenberg et al. 2010.md](#-file-04_knowledge-base-wiki-sources-literature-note-—-stenberg-et-al--2010-md) (~263 words)
- [04_Knowledge Base/wiki/sources/Literature Note — Thenkabail et al. 2001.md](#-file-04_knowledge-base-wiki-sources-literature-note-—-thenkabail-et-al--2001-md) (~212 words)
- [04_Knowledge Base/wiki/sources/Literature Note — Turner et al. 2016.md](#-file-04_knowledge-base-wiki-sources-literature-note-—-turner-et-al--2016-md) (~227 words)
...
*Related: [[04_Knowledge Base/wiki/concepts/Hyperspectral Imaging|Hyperspectral Imaging]] · [[04_Knowledge Base/wiki/entities/PRISMA Satellite|PRISMA]] · [[04_Knowledge Base/wiki/entities/EnMAP Satellite|EnMAP]] · [[02_Academic & Work/thesis/Thesis MOC|Thesis MOC]] · [[02_Academic & Work/thesis/defense-prep/Flashcards — Defense|Flashcards — Defense]]*
...
Emails: `elmansour01abdelhak@gmail.com` (job applications — NEVER insitazoult@) | `abdelhak.elmansour@um6p.ma` (institutional)
...
- [[04_Knowledge Base/wiki/entities/Handheld XRF|Handheld XRF]] — primary thesis XRF baseline
...
- [[Data Asset — XRD Mineralogy Analysis of Sample Z2-40]] — Dolomite, Fluorapatite, and Quartz XRD ratios
- [[Data Asset — AgBS Learning by Doing Cereal and Wheat Dataset]] — Agricultural trade statistics and wheat prices
...
- [[04_Knowledge Base/wiki/entities/PRISMA Satellite|PRISMA Satellite]] — Italian Space Agency hyperspectral mission (30m HSI, 5m PAN)
- [[04_Knowledge Base/wiki/entities/EnMAP Satellite|EnMAP Satellite]] — German spaceborne hyperspectral mission
...
- [[04_Knowledge Base/wiki/concepts/Research Note — Shepelife Classification Accuracy Analysis|Research Note — Shepelife Classification Accuracy Analysis]] — Analysis of low accuracy metrics (15-27%) and scale mismatches
- [[04_Knowledge Base/wiki/concepts/Early Draft — Hyperspectral Characterization of Phosphatic Waste Rocks 2022|Early Draft — Hyperspectral Characterization of Phosphatic Waste Rocks 2022]] — Terminology evolution and early HSI paper design from 2022
...
- [[04_Knowledge Base/wiki/sources/Literature Note — Thenkabail et al. 2001|Literature Note — Thenkabail et al. 2001]] — Optimal hyperspectral narrowbands for crop/soil characterization
- [[04_Knowledge Base/wiki/sources/Literature Note — Rasti et al. 2020|Literature Note — Rasti et al. 2020]] — Feature extraction and dimensionality reduction review
- [[04_Knowledge Base/wiki/sources/Literature Note — Brossard et al. 2016|Literature Note — Brossard et al. 2016]] — Hyperspectral mapping for industrial and mining minerals (French)
- [[04_Knowledge Base/wiki/sources/Literature Note — Casa et al. 2020|Literature Note — Casa et al. 2020]] — PRISMA satellite topsoil property estimation (EGU 2020)
...
- [[Fluorapatite Reference Diffraction Pattern 96-901-0506]] — Peak and d-spacing reference for validation
- [[Data Asset — XRD Mineralogy Analysis of Sample Z2-40]] — Quantitative phase analysis of dolomite-rich waste rocks
...
- [[04_Knowledge Base/wiki/sources/Literature Note — Johansen et al. 2018|Literature Note — Johansen et al. 2018]] — UAV mine rehabilitation performance assessment
- [[04_Knowledge Base/wiki/sources/Literature Note — Stenberg et al. 2010|Literature Note — Stenberg et al. 2010]] — Soil spectroscopy for monitoring soil properties
...
## 📄 File: 04_Knowledge Base/wiki/entities/ECOSTRESS Spectral Library.md
...
## 📄 File: 04_Knowledge Base/wiki/entities/EnMAP Satellite.md
...
## 📄 File: 04_Knowledge Base/wiki/entities/Handheld XRF.md
...
## 📄 File: 04_Knowledge Base/wiki/entities/Jbel N'Zourk Copper Deposit.md
...
- [[04_Knowledge Base/wiki/entities/PRISMA Satellite]]
...
## 📄 File: 04_Knowledge Base/wiki/entities/PRISMA Satellite.md
...
## 📄 File: 04_Knowledge Base/wiki/entities/South Benguerir Phosphate Deposit.md
...
## 📄 File: 04_Knowledge Base/wiki/entities/Tiouit Gold Deposit.md
...
## 📄 File: 04_Knowledge Base/wiki/entities/Touroug Baryte Deposit.md
...
## 📄 File: 04_Knowledge Base/wiki/entities/X'Pert HighScore Plus.md
...
* **Cross-Scale Calibration**:
  * Satellite sensors like **[[04_Knowledge Base/wiki/entities/PRISMA Satellite|PRISMA]]** and **[[04_Knowledge Base/wiki/entities/EnMAP Satellite|EnMAP]]** map surface mineral abundances across $30\text{ m}$ pixels.
...
* [[04_Knowledge Base/wiki/concepts/AMICS Target Mineral Quantification|AMICS Target Mineral Quantification]]
* [[04_Knowledge Base/wiki/entities/Handheld XRF|Handheld XRF]]
...
## Related Notes
* [[04_Knowledge Base/wiki/entities/PRISMA Satellite|PRISMA Satellite]]
...
- [[04_Knowledge Base/wiki/entities/PRISMA Satellite]] — instrument spectral range
...
## 📄 File: 04_Knowledge Base/wiki/concepts/Clay Mineral Identification — XRD-XRF vs Spectroscopy.md

---
tags:
date: 2026-07-15
summary: "Comparison of XRD, XRF, VNIR-SWIR spectroscopy, and hyperspectral imaging for identifying and differentiating clay minerals with confidence."
aliases:
---
...
### XRD — crystal lattice, the reference method
Diagnostic because it measures d-spacing (Bragg's Law), which is species-specific. Clay identification requires a treatment sequence, not a single scan:
- **Smectite**: 14–15 Å air-dried → expands to ~17 Å on ethylene glycol solvation → collapses to ~10 Å at 550°C.
- **Vermiculite**: ~14 Å, does NOT expand with glycol (separates it from smectite) → collapses to ~10 Å on heating.
- **Chlorite**: 14 Å, stable through both glycolation and heating (separates it from smectite/vermiculite).
- **Illite**: 10 Å, stable through all treatments.
- **Kaolinite**: 7 Å, destroyed entirely at 550°C (separates it from chlorite, which shares a ~7 Å second-order peak but survives heating).
Limitation: point/bulk, destructive prep, lab-only, weak on trace phases (<2–5%) and interstratified clays (needs modeling, e.g. NEWMOD).

### XRF — elemental constraint, not species ID
Gives bulk chemistry (Si, Al, Fe, Mg, K, Ca), not mineral species. High K+Al narrows toward illite/muscovite; high Mg+Fe narrows toward chlorite/smectite — but different minerals can share similar bulk chemistry. Functions as an independent geochemical cross-check on XRD or spectral unmixing results, not a standalone identifier — this is exactly how [[Phosphate Mineral Validation Scheme]] uses HHXRF in Chapter 1.

### VNIR-SWIR spectroscopy — vibrational absorption features
Diagnostic mechanism is molecular vibration (OH, Al-OH, Mg-OH combination/overtone bands), not crystal lattice — see [[VNIR-SWIR Spectroscopy]] for the full physical basis. Key clay-diagnostic regions:
- ~1400 nm: OH overtone (broad, most clays)
- ~1900 nm: H₂O combination (interlayer/adsorbed water — helps separate hydrated smectites)
- ~2160–2220 nm: Al-OH (kaolinite doublet at 2160/2180 nm; illite/muscovite ~2200 nm)
- ~2250–2350 nm: Mg-OH/Fe-OH (chlorite ~2250 & 2350 nm; smectite ~2300 nm; carbonate ~2320–2340 nm is a common confuser here)
Method: continuum removal + band depth/position/asymmetry analysis, matched against reference libraries (USGS splib, ECOSTRESS) via [[Spectral Library Matching]]. Sensitive to particle size, moisture, and — critically for waste-rock/soil settings — feature dilution when clay is a minor component of a mixed matrix.

### Hyperspectral imaging — spatial mapping + unmixing
Same physical basis as point spectroscopy, plus the spatial dimension and the unmixing problem: each pixel is a mixture of multiple minerals + soil + vegetation + shade (VCA-FCLS / NNLS, see [[Spectral Unmixing VCA-FCLS]]). Confidence depends heavily on spectral resolution — EnMAP's ~6.5 nm SWIR bands resolve the kaolinite doublet; PRISMA's coarser SWIR often cannot. ML classifiers (RF, Extra Trees, CNN) trained on band-depth inputs generally outperform simple SAM matching for multi-class discrimination when ground-truthed against XRD/XRF.

```mermaid
graph LR
    A[Hyperspectral / Spectroscopy] -->|spatial screening + rapid mapping| C[Candidate mineral map]
    C -->|point confirmation| B[XRD]
    B -->|definitive species ID| D[Confirmed clay assemblage]
    A -->|elemental cross-check| E[XRF]
    E -->|constrains chemistry| D
```

## Applications
| Method | Good at | Fails alone |
|---|---|---|
| XRD | Definitive species ID, swelling vs non-swelling clays | Bulk/point only, lab-bound, poor on trace phases |
| XRF | Fast elemental screening, cross-validation | Cannot resolve mineral species from chemistry alone |
| Point spectroscopy | Fast, non-destructive, field-usable | Ambiguous under mineral mixing, particle-size/moisture effects |
| Hyperspectral imaging | Spatial mapping, scalable, remote | Needs strong SWIR resolution + ground truth; unmixing errors compound |

Applied directly in Abdelhak's thesis pipeline: [[VNIR-SWIR Spectroscopy]] + HHXRF for field screening (Ch.1), PRISMA hyperspectral classification (Ch.2), EnMAP unmixing (Ch.3) — all cross-validated against XRD per [[XRD and Petrographic Validation of Classification Labels]].
...
## 📄 File: 04_Knowledge Base/wiki/concepts/Data Asset — AgBS Learning by Doing Cereal and Wheat Dataset.md

---
date: 2026-06-25
tags:
summary: "Data assets from the Agricultural Business and Systems (AgBS) 'Learning by Doing' Short Course #1, covering cereal composition and wheat trade."
---


# Data Asset — AgBS Learning by Doing Cereal and Wheat Dataset

[[D-Drive — Abdel]]

## Overview

- **Source Folder**: `D:\Abdel\Info_and_files_for_tomorrow_AgBS_Learning_by_Doing_Short_Course_#1_\`
- **Context**: Materials from an Agricultural Business and Systems (AgBS) learning module from 2021/2022. It represents coursework data outside of the core remote sensing thesis.

## Dataset Structure

The subfolder contains 8 CSV files detailing trade and composition metrics:

1. **`cereal compo.csv`**: Nutritional content comparisons. Maize and wheat energy indexes:
   - Maize: 1.000 (baseline)
   - Wheat: 0.992
2. **`commodity prices.csv`**: Monthly agricultural commodity price indexes (e.g. Meat Index, 4/2020 = 96.9, 5/2020 = 95.4).
3. **`export.csv`**: Regional grain export figures (encoded in CP1252).
4. **`trade matrix.csv`**: Global trade matrix between exporters and importers (e.g. Argentina to Africa = 1,830,773 units, to Algeria = 1,524,830 units).
5. **`wheat gap.csv`**: Wheat production and import quantities for regional zones (e.g. Africa 2019 Imports = 47,621 kt, Production = 26,583 kt).
6. **`wheat imp af.csv`**: Sub-national import figures across Africa (e.g. Algeria = 6,788 kt, Angola = 1,089 kt).
7. **`wheat import countries.csv`**: Country-specific wheat import timelines (encoded in CP1252).
8. **`wheat prices.csv`**: Hard Red Winter (HRW) wheat prices from 1982 to 2020 (e.g. 4/1982 = $169.76/t, 5/1982 = $167.55/t).

## Links

- Main D-Drive Index: [[D_Drive_Master_Hub]]
...
- [[04_Archives/D-Drive/D-Drive — PHD-1st]]
- [[04_Knowledge Base/wiki/concepts/X-Ray Diffraction (XRD) in Mineralogy]]
- [[04_Knowledge Base/wiki/entities/X'Pert HighScore Plus]]
- [[04_Knowledge Base/wiki/concepts/Rietveld Refinement in XRD]]
...
## 🕸️ Relationships & Connections
*   **related-concept**:: [[04_Knowledge Base/wiki/entities/PRISMA Satellite|PRISMA Satellite]]
*   **related-concept**:: [[04_Knowledge Base/wiki/entities/EnMAP Satellite|EnMAP Satellite]]
...
## 📄 File: 04_Knowledge Base/wiki/concepts/Data Asset — XRD Mineralogy Analysis of Sample Z2-40.md

---
date: 2026-06-25
tags:
summary: "Quantitative phase analysis results from XRD for sample Z2-40_17285, showing dominance of Dolomite and Fluorapatite."
---


# Data Asset — XRD Mineralogy Analysis of Sample Z2-40

[[D-Drive — Abdel]]

## Dataset Overview

- **Source File**: `D:\Abdel\sasasas.csv`
- **Sample ID**: `Z2-40_17285`
- **Analysis Type**: Quantitative X-ray Diffraction (XRD) Phase Identification and Rietveld Refinement.
- **Date Associated**: June 2022

## Quantitative Phase Abundances

The crystalline mineral phases matching the diffraction pattern of sample `Z2-40_17285` are:

| Entry Code | Chemical Formula | Mineral Name | Quantitative Abundance (%) |
| :--- | :--- | :--- | :--- |
| `96-900-3524` | $\text{CaMg(CO}_3)_2$ (expressed as $\text{C Ca}_{0.5}\text{Mg}_{0.5}\text{O}_3$) | **Dolomite** | **65.9%** |
| `96-901-0506` | $\text{Ca}_5(\text{PO}_4)_3\text{F}$ (expressed as $\text{C}_{0.078}\text{Ca}_5\text{F}_{0.842}\text{O}_{12.402}\text{P}_{2.895}$) | **Fluorapatite** | **25.7%** |
| `96-900-5018` | $\text{SiO}_2$ (expressed as $\text{O}_2\text{Si}$) | **Quartz** | **8.4%** |

## Geological Context

Sample `Z2-40` is a carbonate-rich phosphatic waste rock. The mineralogy is dominated by **Dolomite (65.9%)**, representing the marl/carbonate interlayer waste, and contains significant **Fluorapatite (25.7%)** (phosphate mineral) and a minor silica fraction (**Quartz 8.4%**).

## Links

- Calibration data: [[04_Knowledge Base/wiki/concepts/XRD and Petrographic Validation of Classification Labels]]
- Reference crystal: [[04_Knowledge Base/wiki/concepts/Fluorapatite Reference Diffraction Pattern 96-901-0506]]
...
## Related Notes
* [[04_Knowledge Base/wiki/entities/ECOSTRESS Spectral Library|ECOSTRESS Spectral Library]]
* [[04_Knowledge Base/wiki/concepts/ECOSTRESS Library File Structure and Naming|ECOSTRESS Library File Structure and Naming]]
* [[04_Knowledge Base/wiki/concepts/Spectral Library Matching|Spectral Library Matching]]
* [[04_Knowledge Base/wiki/concepts/Spectral Analysis|Spectral Analysis]]
...
## 📄 File: 04_Knowledge Base/wiki/concepts/Early Draft — Hyperspectral Characterization of Phosphatic Waste Rocks 2022.md

---
date: 2026-06-25
tags:
summary: "Analysis of early paper drafts and outlines from 2022, highlighting terminology evolution to the final 2026 thesis."
---


# Early Draft — Hyperspectral Characterization of Phosphatic Waste Rocks (2022)

[[D-Drive — Abdel]]

## Overview

This note captures the early research design and draft abstract written by Abdelhak in June 2022, as found in the documents `Abstract2022.docx` and `Plan-HSI.docx` in the `D:\Abdel\UNTIII` directory.

## Paper Design & Terminology Evolution

The draft describes using PRISMA spaceborne hyperspectral images to characterize waste rock piles at the Benguerir open-pit phosphate mine.

### Terminology Changes (2022 vs 2026)

There is a clear evolution in how the lithological classes and materials are named:

| 2022 Draft Terminology (`Abstract2022.docx`) | 2026 Thesis Terminology (`Thesis Overview.md`) |
| :--- | :--- |
| **Limestones** | **Limestone** |
| **Marls** | **Marl** |
| **Flint** | **Siliceous facies** |
| **Phosphatic sand** | **Phosphate rock** |

### Early Spectral Diagnostics Identified

- **300 nm and 500 nm**: Wavelengths mapped to iron oxide absorption features.
- **2200 nm and 2300 nm**: Absorption bands associated with clay minerals (marls) and carbonate (lime/limestone) traces.

## Paper Structure Plan (2022)

The planned paper structure outlined in `Plan-HSI.docx` is:
1. **Introduction**: HSI advantages for mine waste, research objectives, and value add.
2. **Materials & Methods**: HSI data acquisition (Satellite/UAV), sample collection, ENVI pre-processing.
3. **Results**: Corrected HSI images and laboratory validation.
4. **Discussion**: Spatial variability and added value.
5. **Conclusion**: Summary and perspectives.

## Links

- Current Chapter 2 overview: [[02_Academic & Work/thesis/Thesis Overview]]
- Conceptual class descriptions: [[04_Knowledge Base/wiki/concepts/PRISMA Lithological Mapping Performance Metrics]]
...
## 📄 File: 04_Knowledge Base/wiki/concepts/Fluorapatite Reference Diffraction Pattern 96-901-0506.md

---
date: 2026-06-25
tags:
summary: "Reference crystallographic diffraction pattern data (d-spacing and intensity peaks) for Fluorapatite entry 96-901-0506."
---


# Fluorapatite Reference Diffraction Pattern 96-901-0506

[[D-Drive — Abdel]]

## Overview

This note indexes the reference diffraction peak pattern for **Fluorapatite** ($\text{Ca}_5(\text{PO}_4)_3\text{F}$), crystallographic COD database entry `96-901-0506`, which is the primary phosphate phase detected in the Benguerir mine waste rocks.

## Diagnostic Diffraction Peaks

- **Source File**: `D:\Abdel\Refpattern_96-901-0506xqxqxq.dif`
- **Max Intensity Peak**: d-spacing = **2.801 Å** (relative intensity 1000.0)

The top diagnostic d-spacing peaks (with intensity > 50) are:

| d-spacing (Å) | Relative Intensity | Description |
|---|---|---|
| **2.801** | 1000.0 | Primary diagnostic peak |
| **2.704** | 562.9 | Secondary diagnostic peak |
| **2.774** | 436.4 | Carbonate/Fluorapatite overlap |
| **3.444** | 367.3 | Tertiary diagnostic peak |
| **2.625** | 240.0 | Quadruple peak |
| **2.250** | 216.2 | Diagnostic peak |
| **3.066** | 154.5 | Base peak |
| **3.170** | 103.1 | Base peak |
| **8.112** | 96.1 | Low-angle peak |
| **4.056** | 61.3 | Mid-angle peak |
| **3.873** | 61.4 | Mid-angle peak |

## Relevance to Mineral Inversion

In Chapter 1, mineral abundances are validated using XRD and compared to SWIR-HHXRF models. This pattern acts as the reference benchmark for confirming the presence of apatite in mixed mine tailings.

## Links

- Sample analysis: [[04_Knowledge Base/wiki/concepts/Data Asset — XRD Mineralogy Analysis of Sample Z2-40]]
- Methods: [[04_Knowledge Base/wiki/concepts/XRD and Petrographic Validation of Classification Labels]]
...
- [[04_Knowledge Base/wiki/entities/PRISMA Satellite]] — instrument context
...
- [[04_Knowledge Base/wiki/entities/PRISMA Satellite]] — sensor specs
...
- **Satellite Ch.2:** [[04_Knowledge Base/wiki/entities/PRISMA Satellite]] (~250 bands, 30m)
- **Satellite Ch.3:** [[04_Knowledge Base/wiki/entities/EnMAP Satellite]] (189 valid bands, 30m)
...
## Relevance to Abdelhak's Research
In [[Phosphate Mine Waste]] rocks, clay minerals (like smectite, illite, chlorite, and kaolinite) indicate weathering and reclamation progress. When using **[[04_Knowledge Base/wiki/entities/Handheld XRF|Handheld XRF (HHXRF)]]** or laboratory XRF to calibrate clay abundance maps:
...
## 📄 File: 04_Knowledge Base/wiki/sources/Literature Note — Brossard et al. 2016.md

---
date: 2026-06-25
tags:
summary: "Study on the contribution of hyperspectral imaging in characterizing industrial and mining minerals, emphasizing mineral mapping, unmixing, and spectral diagnostics."
---


# Literature Note — Apport de l'imagerie hyperspectrale pour les minéraux

[[D-Drive — Abdel]]

## Overview

Written in French ("Apport de l'imagerie hyperspectrale pour la caractérisation des minéraux industriels et miniers"), this paper explores how hyperspectral cubes can be unmixed and analyzed to map mining faces and identify industrial minerals.

## Key Methods

- **Spectral Diagnostics**: Identification of spectral features of carbonates, clays, and silica in the SWIR and LWIR regions.
- **Spectral Unmixing**: Utilizes reference libraries and linear unmixing models to map relative mineral abundance within sub-pixel mixes.
- **Industrial Focus**: Highlights the role of HSI in quality control for mining operations (waste-ore segregation).

## Relevance to Thesis

Directly aligns with Abdelhak's objective of mineralogical characterization of phosphate mine waste rocks. It supports the linear spectral unmixing (VCA+FCLS) methodology applied to EnMAP data in Chapter 3 to determine the mineral composition (Marl, Limestone, Phosphate, Siliceous) at the sub-pixel level.

## Links

- Method: [[04_Knowledge Base/wiki/concepts/Spectral Analysis]]
- Site context: [[04_Knowledge Base/wiki/entities/OCP Group and Benguerir Mine]]




## 📄 File: 04_Knowledge Base/wiki/sources/Literature Note — Casa et al. 2020.md

---
date: 2026-06-25
tags:
summary: "Evaluation of PRISMA spaceborne hyperspectral data for estimating topsoil properties of agricultural interest at the field scale."
---


# Literature Note — PRISMA Data for Topsoil Property Estimation

[[D-Drive — Abdel]]

## Overview

Presented at the EGU General Assembly 2020, this work evaluates the quality and performance of the PRISMA imaging spectrometer for mapping agricultural soil characteristics (such as organic carbon, texture, and calcium carbonate) at the field scale.

## Key Outcomes

- **Sensor Validation**: PRISMA's SWIR bands demonstrate strong performance for detecting clay mineral doublets and carbonate features.
- **Topsoil Properties**: Calibrations built on field spectral libraries (e.g. using PLSR) can be successfully upscaled to PRISMA imagery, despite atmospheric attenuation and spatial resolution limits (30 m).

## Relevance to Thesis

PRISMA is the core spaceborne sensor for Chapter 2 of Abdelhak's thesis, which focuses on lithological mapping of phosphate mine waste rocks. This study validates that PRISMA's signal-to-noise ratio (SNR) in the SWIR is sufficient to map geological surfaces and soil properties under real-world conditions.

## Links

- Sensor: [[04_Knowledge Base/wiki/entities/PRISMA Satellite]]
- Soil Calibration: [[04_Knowledge Base/wiki/concepts/Spectral Analysis]]




## 📄 File: 04_Knowledge Base/wiki/sources/Literature Note — Johansen et al. 2018.md

---
date: 2026-06-25
tags:
summary: "Study using UAV (drone) photogrammetry and multispectral data to assess vegetation cover and rehabilitation success in open-cut mines."
---


# Literature Note — UAVs for Assessing Mine Rehabilitation Performance

[[D-Drive — Abdel]]

## Overview

This paper demonstrates the utility of high-resolution Unmanned Aerial Vehicle (UAV) data (combining multispectral imagery and digital surface models) to evaluate rehabilitation performance (vegetation cover, height, and erosion) in open-cut coal mines in Australia.

## Key Methodology & Results

- **UAV Platform**: Captured sub-decimeter orthomosaics and 3D surface models.
- **Metrics Evaluated**:
  - Ground cover fraction (using vegetation indices like NDVI).
  - Vegetation structure/height (derived from structure-from-motion photogrammetry).
  - Erosion and drainage channel mapping using terrain indices.
- **Key Conclusion**: UAVs bridge the scale gap between point-based field surveys and satellite-based monitoring, providing repeatable and objective metrics for regulatory compliance in mining reclamation.

## Relevance to Thesis

Directly supports the "Reclamation Monitoring" dimension of Abdelhak's thesis. While Abdelhak uses spaceborne EnMAP/PRISMA data for site-scale mapping, this paper provides comparative methods for high-resolution UAV validation of reclamation zones (e.g. vegetation density and surface stability).

## Links

- Index: [[04_Knowledge Base/wiki/concepts/Waste Rock Characterization]]
- Site: [[04_Knowledge Base/wiki/entities/OCP Group and Benguerir Mine]]




## 📄 File: 04_Knowledge Base/wiki/sources/Literature Note — Rasti et al. 2020.md

---
date: 2026-06-25
tags:
summary: "Comprehensive review of feature extraction and dimensionality reduction methods (linear, non-linear, sparse, deep learning) for hyperspectral image classification."
---


# Literature Note — Feature Extraction for Hyperspectral Image Classification

[[D-Drive — Abdel]]

## Overview

This review paper taxonomizes and evaluates state-of-the-art feature extraction (FE) and dimensionality reduction (DR) techniques used to resolve the "Hughes phenomenon" (curse of dimensionality) in hyperspectral data processing.

## Classification of Methods

- **Unsupervised FE**: PCA (Principal Component Analysis), MNF (Minimum Noise Fraction), and ICA (Independent Component Analysis).
- **Supervised FE**: LDA (Linear Discriminant Analysis), local Fisher discriminant analysis.
- **Nonlinear & Sparse FE**: KPCA (Kernel PCA), manifold learning (Isomap, LLE), and sparse representation.
- **Deep Learning-Based FE**: Autoencoders (AEs), Convolutional Neural Networks (CNNs) for spatial-spectral feature learning.

## Relevance to Thesis

Directly supports the machine learning pipelines in Chapter 2 (PRISMA lithology classification) and Chapter 3 (EnMAP regression). Abdelhak utilizes ANOVA F-tests and spatially constrained cross-validation to select bands, ensuring stable feature extraction without overfitting.

## Links

- Concept page: [[04_Knowledge Base/wiki/concepts/Machine Learning for Hyperspectral]]
- Satellite: [[04_Knowledge Base/wiki/entities/PRISMA Satellite]]




## 📄 File: 04_Knowledge Base/wiki/sources/Literature Note — Stenberg et al. 2010.md

---
date: 2026-06-25
tags:
summary: "Comprehensive review on visible and near-infrared diffuse reflectance spectroscopy in soil science, covering calibration, instrumentation, and soil property predictions."
---


# Literature Note — Visible and Near Infrared Spectroscopy in Soil Science

[[D-Drive — Abdel]]

## Overview

This highly cited review paper in *Advances in Agronomy* outlines the fundamentals, multivariate calibrations, and application domains of visible and near-infrared (vis-NIR, 350–2500 nm) diffuse reflectance spectroscopy in soil science.

## Key Concepts & Methods

- **Fundamentals**: vis-NIR spectroscopy relies on overtones and combination bands of fundamental vibrations in the mid-infrared (MIR) region. The main chromophores in soil are soil organic matter, clay minerals (OH groups, metal-OH bendings), and iron oxides (charge transfer transitions in the UV-vis-NIR).
- **Multivariate Calibrations**: Discusses PLSR (Partial Least Squares Regression), PCR (Principal Component Regression), and machine learning (SVM, ANN) for soil property prediction.
- **Application Domains**:
  - **Soil Organic Matter (SOM)**: Highly predictable via vis-NIR due to absorption by organic compounds.
  - **Soil Mineralogy**: Clay minerals (e.g., kaolinite, illite, smectite) exhibit sharp absorption features in the SWIR (1400 nm, 1900 nm, and 2200–2300 nm).
  - **Soil Texture**: High correlations for clay content, moderate for sand/silt.
  - **Nutrients & pH**: Indirect predictions through associations with clay or organic matter complexes.

## Relevance to Thesis

Provides the foundational scientific framework for Chapter 1 (field spectroscopy using ASD FieldSpec 4) and Chapter 3 (soil and reclamation monitoring). It explains how clay minerals and iron oxides dominate spectral signatures, which masks minor phases like apatite.

## Links

- Study Site Framework: [[04_Knowledge Base/wiki/concepts/Spectral Analysis]]
- Instruments: [[04_Knowledge Base/wiki/concepts/Hyperspectral Imaging]]




## 📄 File: 04_Knowledge Base/wiki/sources/Literature Note — Thenkabail et al. 2001.md

---
date: 2026-06-25
tags:
summary: "Study identifying optimal narrow bands in the UV, Blue, Green, Red, NIR, and SWIR spectrum for crop and soil characterization."
---


# Literature Note — Optimal Hyperspectral Narrowbands for Discrimination

[[D-Drive — Abdel]]

## Overview

This fundamental study identifies the most informative narrow bands within the 350–2500 nm range for crop classification, agricultural biochemical analysis, and soil moisture estimation.

## Key Findings

- **Wavelength Selection**: Identified 12 optimal narrowbands that capture over 90% of agricultural information:
  - **UV/Blue**: 490 nm (chlorophyll absorption).
  - **Green**: 550 nm (vegetation vigor).
  - **Red**: 675 nm (chlorophyll absorption max).
  - **Red-edge**: 700 nm, 720 nm, 740 nm (critical for stress/biomass).
  - **NIR**: 900 nm, 970 nm (water absorption).
  - **SWIR**: 1450 nm, 2200 nm (soil moisture, clays, and mineralogy).
- **Aviation vs Spaceborne HSI**: Demonstrates that narrow bands (10 nm width) provide significantly higher classification accuracies than broad bands (Sentinel/Landsat).

## Relevance to Thesis

Relates to the selection of optimal bands for spaceborne sensors. In Chapter 2, Abdelhak uses ANOVA-based F-testing to select **60 SWIR bands** from PRISMA for lithological mapping. This paper provides the physical and agricultural justification for band selection in both lithology mapping and revegetation tracking.

## Links

- Method: [[04_Knowledge Base/wiki/concepts/Spectral Analysis]]
- Sensors: [[04_Knowledge Base/wiki/entities/PRISMA Satellite]]




## 📄 File: 04_Knowledge Base/wiki/sources/Literature Note — Turner et al. 2016.md

---
date: 2026-06-25
tags:
summary: "Reflectance spectroscopy characterization (500–2500 nm) of rare earth element (REE) phosphate minerals (monazite, xenotime, britholite) and the identification of diagnostic absorption features."
---


# Literature Note — Reflectance Spectroscopy of REE Phosphate Minerals

[[D-Drive — Abdel]]

## Overview

This study investigates the visible to short-wave infrared (500–2500 nm) reflectance spectra of rare earth element (REE) phosphate minerals (monazite, xenotime, and britholite) to identify diagnostic absorption features useful for geological exploration and mine waste monitoring.

## Key Findings

- **Monazite (Ce,La,Nd,Th)PO₄**: Displays prominent absorption features at 740, 800, and 870 nm due to Neodymium ($Nd^{3+}$) electron transitions. Broad water/hydroxyl absorption bands are observed around 1400 and 1900 nm due to alterations/fluid inclusions.
- **Xenotime (Y,Yb)PO₄**: Shows diagnostic narrow absorption bands in the NIR-SWIR range, particularly at 975, 1150, and 1530 nm, caused by Dysprosium ($Dy^{3+}$) and Erbium ($Er^{3+}$) transitions.
- **Spectral Resolution**: Detection of REE features requires sub-10 nm spectral resolution due to the narrow nature of rare-earth electron shells shielding f-f transitions.

## Relevance to Thesis

Abdelhak's thesis maps phosphate mine waste rocks at the Benguerir mine. Phosphate ores are known hosts for REEs (like monazite/xenotime). This note provides spectral search rules for identifying potential REE anomalies in high-resolution field or spaceborne hyperspectral data (such as EnMAP).

## Links

- Concept page: [[04_Knowledge Base/wiki/concepts/Spectral Analysis]]
- Minerals page: [[04_Knowledge Base/wiki/concepts/Waste Rock Characterization]]
